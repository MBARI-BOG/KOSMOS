...
### Description
This R markdown file contains all of the analyses for the KOSMOS paper. Please note - some data files (i.e., the sequencing data) are too large to upload to GitHub and therefore some code chunks will not work. If you require these datasets, please contact me at mmin@uw.edu.
