...
### Description
This R markdown file contains all of the analyses for the KOSMOS paper. Please note - some data files (e.g. shapefiles) are too large to upload to GitHub and therefore some code chunks will not work. If you require these datasets, please contact me at mmin@uw.edu.
...
ggsave("legend_final.png", width = 11, height = 1,path = "/Users/mmin/Documents/KOSMOS_paper_figures/biogeochemical_figure/v4_FINAL")
```
...
# PC Loadings Analysis: Unmerged ASVs (Figure 4)
...
ggsave("/Users/mmin/Documents/KOSMOS_paper_figures/PCA_figure/FINAL/16S_bacterial_PC1_unmerged_top30_100520.png",bacteria_PCA_gg,width = 7, height = 8.5)
```
